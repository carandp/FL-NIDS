...
def main():
    ...
    for client in clients:
        data_dir = os.path.abspath(os.path.join(
            os.path.dirname(__file__), f"../datasets/fed_clients/{client}"
        ))
    ...
    # HE persistence stores tensors as serialized bytes.
    ...
    # 4) Separate classes — subsample ONLY benign, keep ALL attacks
