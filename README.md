...
- **Parametric Study.** Contains the simulations varying the noise multiplier (σ) to generate accuracy-privacy trade-off curves.

### 1.5 paper/

This folder containes the LaTeX code and PDF of the projects' paper.
